...
public class SaveData : MonoBehaviour
{
    ...
    public SaveData(int[] purchasedCosmeticIDs, int[] purchasedCharacterIDs, int[] gainedAchievementIDs, int equippedHatID, int equippedWingID, int equippedCharacterID, int gold, HighScoreData bestRunData)
    {
    ...
    public SaveData(int[] purchasedCosmeticIDs, int[] purchasedCharacterIDs, int[] gainedAchievementIDs, int equippedHatID, int equippedWingID, int equippedCharacterID, int gold, float highScore, CharacterType character, AttackType attackType, string[] selectedPerkNames)
    {
        this.purchasedCosmeticIDs = purchasedCosmeticIDs;
        this.purchasedCharacterIDs = purchasedCharacterIDs;
        this.gainedAchievementIDs = gainedAchievementIDs;
